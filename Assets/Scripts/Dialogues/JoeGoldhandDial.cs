...
public class JoeGoldhandDial : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        node5.playerOpt_1 = playerOptions[5];
        node5.playerOpt_2 = playerOptions[6];
        node5.left = node6;
        node5.right = node7;
        node5.isLeaf = false;
        dialTree.Add(node5);
        ...
        node7.playerOpt_1 = playerOptions[8];
        node7.playerOpt_2 = "";
        node7.left = null;
        node7.right = null;
        node7.isLeaf = true;
        ...
        node11.playerOpt_1 = playerOptions[9];
        node11.playerOpt_2 = playerOptions[10];
        node11.left = node12;
        node11.right = null;
        node11.isLeaf = false;
        node11.goodbye = true;
        ...
        node13.playerOpt_1 = playerOptions[11];
        node13.playerOpt_2 = "";
        node13.left = null;
        node13.right = null;
        node13.isLeaf = false;
        node13.goodbye = true;
        node13.acceptQuest = true;
        dialTree.Add(node13);
    }
